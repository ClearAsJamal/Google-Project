# Depending on the IDE you're using, the run command may return 'Process finished with exit code 1'
# If it does, run the following command in terminal to run the program:
# py -m src.run
